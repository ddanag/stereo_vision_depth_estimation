...
// clang-format off
    ...
    xf::cv::Mat<XF_8UC1, XF_HEIGHT, XF_WIDTH, XF_NPPC1> leftRemappedMat_after_median_blur(rows, cols);

    xf::cv::Mat<XF_8UC1, XF_HEIGHT, XF_WIDTH, XF_NPPC1> rightRemappedMat_after_median_blur(rows, cols);

    xf::cv::Mat<XF_8UC1, XF_HEIGHT, XF_WIDTH, XF_NPPC1> leftRemappedMat_after_histeq(rows, cols);

    xf::cv::Mat<XF_8UC1, XF_HEIGHT, XF_WIDTH, XF_NPPC1> rightRemappedMat_after_histeq(rows, cols);
...
// clang-format off
    ...
    xf::cv::medianBlur<WINDOW_SIZE, XF_BORDER_REPLICATE, TYPE, XF_HEIGHT, XF_WIDTH, XF_NPPC1>(leftRemappedMat, leftRemappedMat_after_median_blur);
    xf::cv::medianBlur<WINDOW_SIZE, XF_BORDER_REPLICATE, TYPE, XF_HEIGHT, XF_WIDTH, XF_NPPC1>(rightRemappedMat, rightRemappedMat_after_median_blur);

    //xf::cv::equalizeHist<XF_8UC1, XF_HEIGHT, XF_WIDTH, XF_NPPC1> (leftRemappedMat_after_median_blur, leftRemappedMat_after_median_blur, leftRemappedMat_after_histeq);
    //xf::cv::equalizeHist<XF_8UC1, XF_HEIGHT, XF_WIDTH, XF_NPPC1> (rightRemappedMat_after_median_blur, rightRemappedMat_after_median_blur, rightRemappedMat_after_histeq);

    xf::cv::StereoBM<SAD_WINDOW_SIZE, NO_OF_DISPARITIES, PARALLEL_UNITS, XF_8UC1, XF_16UC1, XF_HEIGHT, XF_WIDTH,
                     XF_NPPC1, XF_USE_URAM>(leftRemappedMat_after_median_blur, rightRemappedMat_after_median_blur, mat_disp, bm_state);
